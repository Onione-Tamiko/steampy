...
def get_market_listings_from_html(html: str) -> dict:
    ...
    for node in nodes:
##        print('[utils][SellNode]',node.text)
...
##            'url':listing_raw.findAll('div', {'class': 'market_listing_item_name_link'})[0].text.strip(),
...
##        print(order)
        ...
        order = {
            ...
            'url':order.findAll('a', {'class': 'market_listing_item_name_link'})[0]['href'],
